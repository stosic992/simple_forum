...
?>
	...
	<input class="pass" type="password" name="lozinka" placeholder="Unesite lozinku" style="
    width: 90%;
    padding: 12px;
    ...
    resize: vertical;
"/><br><br>
	<input class="pass" type="password" name="potvrdalozinke" placeholder="Potvrdite lozinku" style="
    width: 90%;
    padding: 12px;
    border: 1px solid #ccc;
    border-radius: 4px;
